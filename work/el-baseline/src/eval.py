...
class Eval(object):
    ...
    def micro_f1(self):
        ...
        golden_text_list = []
        for line in open(self.golden_file_path, encoding='utf8'):
        ...
        for line in open(self.user_file_path, encoding='utf8'):
            golden_info = json.loads(line.strip())
            text_id = golden_info['text_id']
...
if __name__ == '__main__':
    ...
    if len(sys.argv) == 3:
        golden_file_name = sys.argv[2]
    else:
        golden_file_name = '../../data/dev.json'
    print(eval(golden_file_name, dev_file_name))